---
description: >-
  Gunbot поддерживает торговлю на многих биржах. Биржи, отмеченные как
  «Сертифицированные», уже давно поддерживаются в Gunbot.
---
...
Эти биржи являются официальными партнерами Gunbot. Мы находимся в прямом контакте со своими командами.

| Биржа | Имя в config | Тип стратегии | Оповещение TradingView |
| :--- | :--- | :--- | :--- |
| **HitBTC** | `hitbtc2` | Regular | Regular |
| **KuCoin** | `kucoin` | Regular | Regular |

## Сертифицированные биржи

Эти биржи давно поддерживаются в Gunbot, можно ожидать качественной поддержки API.

| Биржа | Имя в config | Тип стратегии | Оповещение в TradingView |
| :--- | :--- | :--- | :--- |
